...
const BlogWilliams: NextPage = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-center justify-start py-[120px] px-[60px] box-border gap-[120px] leading-[normal] tracking-[normal] mq725:gap-[30px] mq1025:gap-[60px] mq1025:pl-[30px] mq1025:pr-[30px] mq1025:box-border">
      <section className="w-[1658px] flex flex-col items-center justify-start gap-8 max-w-full text-center text-[96px] text-darkslateblue font-inter mq725:gap-4">
        <h1 className="m-0 self-stretch h-[154px] relative text-inherit font-bold font-[inherit] inline-block shrink-0 mq450:text-10xl mq975:text-[48px]">{`Williams Solutions.Pro Blog `}</h1>
        <h1 className="m-0 self-stretch relative text-[52px] font-medium font-[inherit] text-darkslategray mq450:text-[31px] mq975:text-23xl">
      ...
      <section className="self-stretch h-[659.5px] flex flex-row items-start justify-center flex-wrap content-start pt-0 px-px pb-0 box-border gap-x-14 gap-y-[54px] max-w-full mq725:gap-[27px]">
        ...
        />
        <FrameComponent
          rectangle124="/rectangle-124-1@2x.png"
          mAY262024="NOV 23 , 2023"
        ...
        />
        <FrameComponent
          rectangle124="/rectangle-124-2@2x.png"
          mAY262024="FEB 9, 2021"
